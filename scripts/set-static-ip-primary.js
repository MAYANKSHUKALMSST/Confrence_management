...
async function setStaticIpPrimary() {
  try {
    console.log('🔗 Connecting to Primary Server (10.30.80.148)...');
    await ssh.connect({
      host: '10.30.80.148',
      username: 'mayank',
      password: '9044472544',
...
`;
    ...
    console.log('📝 Creating static IP configuration for pockali...');
    ...
    if (applyRes.stderr && !applyRes.stderr.includes('password')) {
      ...
      console.log('✅ Static IP successfully assigned to eno1 on pockali!');
    }
  } catch (e) {
